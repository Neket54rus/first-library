...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.setAttr = function (oldNameAttr) {
  let newNameAttr = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.removeAttr = function (nameAttr) {
  for (let i = 0; i < this.length; i++) {
